...
@WebServlet("/api/users/shippingAddresses/update")
public class UsersShippingAddressesUpdateServlet extends HttpServlet {
    @Override
    public void init() throws ServletException {
        super.init();
        System.out.println("UsersShippingAddressesUpdateServlet initialized.");
    }
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(
                "UsersShippingAddressesUpdateServlet PUT request received with parameters: " + jsonObject.toString());
        String email = jsonObject.get("email").getAsString();
        int index = jsonObject.get("index").getAsInt();
        String updateShippingAddress = jsonObject.get("updateShippingAddress").getAsString();
