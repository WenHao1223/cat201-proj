...
@WebServlet("/api/users/shippingAddresses/remove")
public class UsersShippingAddressesRemoveServlet extends HttpServlet {
    @Override
    public void init() throws ServletException {
        super.init();
        System.out.println("UsersShippingAddressesRemoveServlet initialized.");
    }
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(
                "UsersShippingAddressesRemoveServlet PUT request received with parameters: " + jsonObject.toString());
