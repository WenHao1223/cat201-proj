...
This project uses TypeScript for type safety and better development experience. Ensure that your TypeScript configuration is set up correctly in `tsconfig.json`.
